    ...
    <div class="col-md-6">
        ...
        <div class="block-web success-box">
            ...
            <div class="porlets-content">
                ...
                <p>Selamat! Aktivasi pengisian formulir telah berhasil. Mohon segera lakukan pembayaran sesuai dengan invoice yang tertera di laman ini.</p>
        ...
        <div class="block-web primary-box">
            ...
            <div class="porlets-content">
                ...
                <?php 
                    if (!isset($_SESSION['statustua'])) {
                        echo "<a href='orangtua.php' class='btn btn-primary btn-block'>ORANG TUA</a>";
                    }else{
                        echo '<a class="btn btn-success btn-block "><span class="glyphicon glyphicon-ok"></span>
                            ORANG TUA
                        </a>';
                    }
                ?>
                ...
                <li class="list-group-item">
                <?php
                    if (!isset($_SESSION['statusdidik'])) {
                        echo "<a href='pendidikan.php' class='btn btn-primary btn-block'>PENDIDIKAN</a>";
                    }else{
                        echo '<a class="btn btn-success btn-block "><span class="glyphicon glyphicon-ok"></span>
                            PENDIDIKAN
                        </a>';
                ...
                <li class="list-group-item">
                    <?php
                        if (!isset($_SESSION['statusdok']))
                        {
                            echo '<a class="btn btn-primary btn-block " href="dokumen.php">DOKUMEN</a>';
                        }else{
                            echo '<a class="btn btn-success btn-block "><span class="glyphicon glyphicon-ok"></span>
                                DOKUMEN
                            </a>';
                    ...
                    <table class="table table-invoice">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php
                                    if (!isset($_SESSION['statusbayar'])) {
                                        echo '<td><a class="btn btn-danger btn-block ">Belum Lunas</a></td>';
                                    }else{
                                        echo '<td><a class="btn btn-success btn-block "><span class="glyphicon glyphicon-ok"></span> Lunas</a></td>';
                                    }
